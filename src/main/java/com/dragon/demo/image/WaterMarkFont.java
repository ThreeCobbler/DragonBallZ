...
public class WaterMarkFont {
    ...
    public static void main(String[] args) {
        ...
        File srcImgFile = new File("E:\\资料\\tupian\\wukong.jpg");
        String logoText = "龟派气功波";

        File outputImageFile = new File("E:\\资料\\tupian\\wukong-1.jpg");

        File outputRotateImageFile = new File("E:\\资料\\tupian\\wukong-2.jpg");
